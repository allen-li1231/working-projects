import os
os.chdir(r'E:\working\Python\O2O')
import pandas as pd
import xgboost as xgb

from sklearn.preprocessing import minmax_scale # newX = X-min / X-max
from sklearn.preprocessing import MinMaxScaler # 对数据集进行处理
#################################################
## 导入数据
...
print(dataset12_x.shape)
dataset12_x.describe()
# =============================================================================
# 模型建立
# =============================================================================
# =============================================================================
...
model = xgb.train(params,dataset12,num_boost_round=20,evals=watchlist)

#predict test set
dataset3_preds['label'] = model.predict(dataset3)
dataset3_preds.label = minmax_scale(dataset3_preds.label)
